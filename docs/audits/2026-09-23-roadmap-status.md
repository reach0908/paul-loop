...
| 3 | native 선행 조건 통제 후 같은 조건의 과제 4쌍 비교 | [격리 후속 관측](2026-09-23-native-isolation.md): USER 제외는 확인. 부모-자식 카탈로그 차이와 planner의 재위임 해석을 먼저 해결한 뒤 첫 diff·완료·재작업 비교. 아직 속도 개선율 없음 |
